...
Sub Main()
    ...
    rutaCarpetaSesiones = "D:\Usuarios\lriver14\AppData\Roaming\VanDyke\Config\Sessions\PRUEBA - TESIS"
    ...
    ' Obtener la colecciÃ³n de archivos en la carpeta	
    ...
    For Each archivo In archivos
        ...
        If LCase(objFSO.GetExtensionName(archivo.Name)) = "ini" Then
            ...
            ' 1. Entrada automÃ¡tica (conexiÃ³n)
